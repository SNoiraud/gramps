  ...
  <object class="GtkToolbar" id="ToolBar">
    ...
    <child>
      <object class="GtkToolButton">
        ...
        <property name="action-name">ste.STARTT</property>
        <property name="tooltip_text" translatable="yes">Go to beginning of text</property>
        <property name="label" translatable="yes">Go to beginning of text</property>
      </object>
      <packing>
        <property name="homogeneous">False</property>
      </packing>
    ...
    <child>
      <object class="GtkToolButton">
        ...
        <property name="action-name">ste.ENDT</property>
        <property name="tooltip_text" translatable="yes">Go to end of text</property>
        <property name="label" translatable="yes">Go to end of text</property>
      </object>
      <packing>
        <property name="homogeneous">False</property>
      </packing>
    ...
    <child>
      <object class="GtkToolButton">
        ...
        <property name="tooltip_text" translatable="yes">Remove the current value from the list</property>
    ...
    <child>
      <object class="GtkToolButton">
        ...
        <property name="tooltip_text" translatable="yes">Clear search history</property>
...
class StyledTextEditor(Gtk.TextView):
    ...
    def create_toolbar(self, uimanager, window):
        ...
        _actions = [
            ...
            ("STARTT", self.go_to_beginning_of_txt),
            ("ENDT", self.go_to_end_of_txt),
        ]
    ...
    def go_to_beginning_of_txt(self, arg1, arg2):
        """
    ...
    def go_to_end_of_txt(self, arg1, arg2):
        """
        Remove the last selected item from the list
        """
        self.index = self.textbuffer.get_char_count()
        self.start_iter = self.textbuffer.get_end_iter()
        self.textbuffer.place_cursor(self.start_iter)
        mark = self.textbuffer.get_insert()
        self.scroll_to_mark(mark, 0.4, True, 0.0, 0.2)
        self.emit('move-cursor', Gtk.MovementStep.LOGICAL_POSITIONS, 0, False)
